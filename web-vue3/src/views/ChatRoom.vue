    ...
    <div class="chat-container">
      ...
      <div class="show-animation" v-if="propDisplay.play">
        <div class="prop-hearts" v-if="propDisplay.showPropType === Prop.HEART">
          <img class="prop-heart" v-for="img in 4" :key="img" src="../assets/images/heart.png">
        </div>
        <img class="prop-rocket" src="../assets/images/rocket.png" v-if="propDisplay.showPropType === Prop.ROCKET">
      </div>
    </div>
  </div>
</template>
